...
namespace SchoolManagementSystem.Admin
{
    public partial class TeacherSubject : System.Web.UI.Page
    {
        ...
        {
            DataTable dt = fn.Fetch(@"Select Row_NUMBER() over (Order by(select 1)) as [Sr.No] , ts.Id , ts.ClassId ,c.ClassId , ts.SubjectId , 
        ...
        protected void GridView1_RowUpdating1(object sender, GridViewUpdateEventArgs e)
        {
            try
            {
                ...
                lblMsg.Text = "Teacher Subject Updated  Succesfuly!";
                lblMsg.CssClass = "alert alert-success";
                GridView1.EditIndex = -1;
                GetTeacherSubject();
            }
